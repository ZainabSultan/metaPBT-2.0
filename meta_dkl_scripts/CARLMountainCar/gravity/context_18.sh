...
context='{"gravity":0.0045000000000000005}'
for seed in {0..5}; do
    kwargs="--ws_dir=$tmp_logs_dir --seed=$seed --env_name=CARLMountainCar --num_samples=4 --context='$context' --max=100000 --t_ready=5000 --num_meta_envs=3 --meta_selection_method=closest --meta_data_base_dir=$TMPDIR/CARLMountainCar_4_agents/gravity/"
