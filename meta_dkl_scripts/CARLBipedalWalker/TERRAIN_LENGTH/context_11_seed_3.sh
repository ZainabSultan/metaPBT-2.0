...
kwargs="--ws_dir=$tmp_logs_dir --seed=3 --env_name=CARLBipedalWalker --num_samples=4 --context='$context' --max=1000000 --t_ready=50000 --num_meta_envs=3 --meta_selection_method=gen --meta_data_base_dir=$TMPDIR/CARLBipedalWalker_4_agents/TERRAIN_LENGTH/"
