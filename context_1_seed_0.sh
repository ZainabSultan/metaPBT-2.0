...
context='{"LEG_H":0.8}'
for seed in {0..9}; do
    kwargs="--ws_dir=$tmp_logs_dir --seed=$seed --env_name=CARLLunarLander --num_samples=4 --context='$context' --max=20000 --t_ready=5000 --num_meta_envs=5 --meta_selection_method=gen --meta_data_base_dir=$TMPDIR/CARLLunarLander_4_agents/LEG_H/"
