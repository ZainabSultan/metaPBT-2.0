...
context='{"VIEWPORT_H":440.00000000000006}'
for seed in {0..9}; do
    kwargs="--ws_dir=$tmp_logs_dir --seed=$seed --env_name=CARLLunarLander --num_samples=4 --scheduler=pb2 --context='$context' --max=1000000 --t_ready=50000"
