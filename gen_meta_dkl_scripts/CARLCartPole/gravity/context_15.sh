...
context='{"gravity":14.700000000000001}'
for seed in {0..9}; do
    kwargs="--ws_dir=$tmp_logs_dir --seed=$seed --env_name=CARLCartPole --num_samples=8 --scheduler=pb2 --context='$context' --max 100000 --t_ready 5000"
