...
context='{"length":0.65}'
for seed in {0..5}; do
    kwargs="--ws_dir=$tmp_logs_dir --seed=$seed --env_name=CARLCartPole --num_samples=4 --context='$context' --max=100000 --t_ready=5000 --num_meta_envs=5 --meta_selection_method=gen --meta_data_base_dir=$TMPDIR/CARLCartPole_4_agents/length/"
