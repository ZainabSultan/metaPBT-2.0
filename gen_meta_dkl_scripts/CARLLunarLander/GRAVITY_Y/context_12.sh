...
context='{"GRAVITY_Y":-12.0}'
for seed in {0..9}; do
    kwargs="--ws_dir=$tmp_logs_dir --seed=$seed --env_name=CARLLunarLander --num_samples=8 --context='$context' --max=1000000 --t_ready=50000 --num_meta_envs=3 --meta_selection_method=closest"
