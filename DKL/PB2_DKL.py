...
def _explore(
    ...
    if not dfnewpoint.empty:
        ...
        new = _select_config(X, y, current, newpoint, bounds, num_f=len(t_r.columns), neural_network= neural_network, seed=seed)
...
class PB2_dkl(PopulationBasedTraining):
    ...
    def _save_trial_state(
        ...
        score = super(PB2_dkl, self)._save_trial_state(state, time, result, trial)
